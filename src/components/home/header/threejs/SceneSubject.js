...
import mask from "../../../../assets/textures/mask.png";
...
export default scene => {
    ...
    var uniforms = {
            texture0: { value: new THREE.TextureLoader().load(dirt)},
            texture1: { value: new THREE.TextureLoader().load(grass)},
            texture2: { value: new THREE.TextureLoader().load(mask)},
