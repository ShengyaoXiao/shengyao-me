    ...
    return (
        <div className="home-section container-about">        
            ...
            <div className="about-text">
                ...
                <br/><br/>I am a senior student at UC San Diego studying math-cs. I am interested in web development, creative coding, computer graphics and human-computer interaction. 
                <br/><br/>As a front-end engineer, I have experience in React ecosystem and data visualization. I am passionate about web. I care about the scenes behind the web as well as the final delivery to the users.
