    ...
    render() {
        ...
        return (
          <div className="post-details-dialog-container margin home-section">
            <div className="post-details-navigate-back-button padding clickable text-unselectable" onClick={this.close}>
                <i className="fa fa-arrow-left post-details-icon" aria-hidden="true" /><span>show all blog posts</span>
            </div> 
            {post ? <PostDetailsCard post={post} /> : <div className="post-not-found">Not found</div>}
          </div>  
        );
    }
}
